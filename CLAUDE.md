...
`tests/` 配下に 29 ファイル、合計 **600 テスト** (599 pass + 1 skip — skip はショートショット 高 threshold ケース)：
...
- `test_skin_layer.py` — 6件: skin OFF/ON、`c_skin=0` で baseline 復元、極薄肉での封止＋未充填検出（`filled_volume_fraction < 0.7`、両集合が交わらない）、metadata の整合性
