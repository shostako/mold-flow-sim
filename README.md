...
- 形状入力：パラメトリック形状（Film gate 1 / 2 = 肉厚調整ゲートの扇状版（肉盗み 1 / 2）、Film gate 3 = 片側版、Film gate 4 = 振り分け／ミニ扇×2（中央を完全肉盗みにしてランナーで左右のミニ扇へ振り分ける検討案）, Direct gate）、または図面から起こした JSON スペック（Profile gate）
