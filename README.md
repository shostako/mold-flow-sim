...
- 形状入力：パラメトリック形状（Film gate 1 / 2 = 肉厚調整ゲートの扇状版（肉盗み 1 / 2）、Film gate 3 = 片側版, Direct gate）、または図面から起こした JSON スペック（Profile gate）
...
2. **形状入力** — パラメトリックゲート 4 種（Film gate 1 / 2 / 3 / Direct gate）と
